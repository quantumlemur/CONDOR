...
if os.path.isfile(finalOutputFileName+'.csv'):
    ...
    fall = open(folder + 'designSpace_ALL.csv', 'wb')
    f1 = open(folder + '1rotor 0aux.csv', 'wb')
    f2 = open(folder + '1rotor 1aux.csv', 'wb')
    f3 = open(folder + '2rotor 0aux.csv', 'wb')
    f4 = open(folder + '2rotor 1aux.csv', 'wb')
